...
function DiningSearch(props)
{
    ...
    const deleteSearch = (e)=>
    {
       if (window.confirm("Do you wish do delete the search " + props.search.name))
       {
         ...
         // axios.delete('https://where-for-dinner-search.apps.h2o-2-22522.h2o.vmware.com/search/' + props.search.id)
    ...
    const loadSearchAvailability= () =>
    {
      ...
      // axios.get('https://where-for-dinner-availability.apps.h2o-2-22522.h2o.vmware.com/availability/' + props.search.name)
